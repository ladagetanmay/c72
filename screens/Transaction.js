...
export default class TransactionScreen extends Component {
	...
	handleTransaction = async () => {
		...
		bookRef.forEach((doc) => {
			...
			if (book.is_book_available) {
				...
				this.initiateBookIssue(studentName,studentId,bookName,bookId);
				ToastAndroid.show("Book issued to the student ",ToastAndroid.SHORT)
			} else {
				var {bookName,studentName} = this.state;
				this.initiateBookReturn(studentName,studentId,bookName,bookId);
				ToastAndroid.show("Book returned by the student to the library ",ToastAndroid.SHORT)
			}
		});
	};
	...
	initiateBookIssue = async (studentName,studentId,bookName,bookId) => {
	...
	initiateBookReturn = async (studentName,studentId,bookName,bookId) => {
		const docRef = await addDoc(collection(db,'transactions'),{
			student_id: studentId,
			student_name :studentName,
			book_id: bookId,
